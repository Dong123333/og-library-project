...
const Chatbot = () => {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
            {isOpen ? (
                <div className="w-full h-screen fixed bottom-0 right-0 md:w-80 md:h-96 md:relative flex flex-col rounded-none md:rounded-t-xl md:rounded-b-xl overflow-hidden shadow-[0_12px_30px_rgba(0,0,0,0.25)] bg-white/95 backdrop-blur-sm">
